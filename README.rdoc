...
As a game developer I want to be able to create mission for the player to play

As a game developer I want to be able to create challenges for the player to overcome

As a player I want to decide what type of crew I have
